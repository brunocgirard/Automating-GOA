...
# Import functions from other project modules that UI pages might need
from crm_utils import get_client_by_id, load_priced_items_for_quote, load_machines_for_quote, load_all_clients, update_client_record, delete_client_record, save_client_info, save_priced_items, save_machines_data, save_document_content, load_document_content
from pdf_utils import extract_line_item_details, extract_full_pdf_text, identify_machines_from_items
from template_utils import extract_placeholder_context_hierarchical
from doc_filler import fill_word_document_from_llm_data
from document_generators import generate_packing_slip_data, generate_commercial_invoice_data, generate_certificate_of_origin_data # Ensure this is imported

# Import from profile_workflow if ui_pages call its functions (e.g. welcome page might call profile extraction)
from profile_workflow import extract_client_profile, confirm_client_profile, show_action_selection, handle_selected_action, load_full_client_profile
    ...
    if prompt := st.chat_input("Your question..."):
        ...
        with st.spinner("Thinking..."):
            try:
                ...
                from llm_handler import answer_pdf_question 
