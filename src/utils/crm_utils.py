...
def init_db(db_path: str = DB_PATH):
    ...
    try:
        ...
        CREATE TABLE IF NOT EXISTS few_shot_examples (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            machine_type TEXT NOT NULL,           -- e.g., "filling", "labeling", "capping", "sortstar"
            template_type TEXT NOT NULL,          -- e.g., "GOA", "default", "sortstar"
            field_name TEXT NOT NULL,             -- The specific field this example is for
            input_context TEXT NOT NULL,          -- The PDF text/context that was used as input
            expected_output TEXT NOT NULL,        -- The correct field value that should be extracted
            confidence_score REAL DEFAULT 1.0,   -- Quality score for this example (0.0-1.0)
            usage_count INTEGER DEFAULT 0,        -- How many times this example has been used
            success_count INTEGER DEFAULT 0,      -- How many times it led to correct results
            created_date TEXT NOT NULL,
            last_used_date TEXT,
            source_machine_id INTEGER,            -- Reference to the machine that generated this example
        ...
        CREATE TABLE IF NOT EXISTS few_shot_feedback (
            ...
            feedback_type TEXT NOT NULL,          -- "correction", "confirmation", "rejection"
            original_prediction TEXT,             -- What the LLM originally predicted
